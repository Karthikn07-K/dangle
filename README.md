...
[![Windows](https://img.shields.io/badge/Windows-10%2F11-0078D4?logo=windows&logoColor=white)](#-download)
[![Python](https://img.shields.io/badge/Built%20with-Python-3776AB?logo=python&logoColor=white)](#-for-developers)
...
Dangle is built with:

-   **Python 3.11+**
-   **PySide6 / Qt**
-   **QPainter**
-   **PyInstaller**
-   Windows APIs for desktop integration

The architecture separates the pendulum simulation from the UI, making
the physics easier to test and evolve.

### Run from source

``` powershell
git clone https://github.com/Karthikn07-K/dangle.git
cd dangle
...
Dangle can expose a custom URI action:

``` text
dangle://bless
```

This can be useful for experiments, shortcuts, automation, demos, or
simply making your desktop charm react from another application.
...
Dangle is open source and contributions are welcome.
...
Before opening a large pull request, consider starting a discussion or
issue so the approach can be agreed upon first.
...
Please do not publicly disclose security-sensitive issues before they
can be reviewed.

See [`SECURITY.md`](SECURITY.md) for the project's security reporting
guidance.
...
Dangle is released under the **MIT License**.
